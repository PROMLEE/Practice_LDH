...
moveimage = image.load('D:/LDH/visual studio LDH/pacman2/images/pacmanmovemap.png')
dotimage = image.load('D:/LDH/visual studio LDH/pacman2/images/pacmandotmap.png')
